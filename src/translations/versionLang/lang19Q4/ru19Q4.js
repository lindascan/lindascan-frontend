...
export const lang19Q4 = {
    ...
    */
    ...
    "token_rank": "Ранг",
    "gain_tip": "24-часовое изменение по сравнению с LIND",
    ...
    "total_supply_tip2": " LIND исключаются.",
    "market_capitalization_t": "Рыночная кепка",
    "token_linda_total": "Общее Количество Токенов LINDA",
    "token_week": "Последние 7 дней",
    "token_scan_total": "Всего на LINDASCAN",
    ...
    */
    ...
    "charts_total_LIND_supply":"Циркуляция LIND в реальном времени и рыночная капитализация",
    "charts_total_LIND_supply_vote":"Вознаграждения голосования",
    ...
    "charts_average_price":"Средняя цена LIND",
    "freezing_column_time": "Время（UTC）",
    "freezing_column_total_circulation": "Общая циркуляция LIND",
    "freezing_column_total_frozen": "Всего замороженных LIND",
    "freezing_column_freezing_rate": "Коэффициент заморозки",
    "freezing_column_freezing_rate_highest": "Коэффициент заморозки:",
    "freezing_column_energy_ratio": "LIND-for-Energy ratio",
    "freezing_column_bandwidth_ratio": "LIND-for-bandwidth ratio",
    "freezing_column_freezing_rate_tip": "количество замороженного LIND / общее количество LIND в циркуляции;",
    "freezing_column_energy_ratio_tip": "Замороженный LIND для энергии / Общее количество замороженного LIND",
    "freezing_column_bandwidth_ratio_tip": "Замороженный LIND для пропускной способности / Общее количество замороженного LIND",
    "freezing_column_more": "Больше",
    "freezing_column_total_circulation_chart": "Общая циркуляция（LIND）",
    "freezing_column_total_frozen_chart": "Всего замороженных（LIND）",
    ...
    "freezing_column_a_total": "Данные замороженных LIND и находятся в циркуляции ",
   ...
   "index_page_footer_donate_address":"Адрес принадлежит LINDA. Ваш донат помогает построить лучшую экосистему LINDA.",
   ...
   "index_page_lindascan_info":"LINDASCAN, лучший blockchain explorer Linda.",
   ...
   "Supply_LIND_total_chart":"Общее количество LIND",
   "Supply_total_y_title":"Общая циркуляция",
   "Supply_amount_LIND":"Количество LIND",
   "Supply_LIND_supply_records":"Циркуляция LIND: всего ",
   "Supply_LIND_supply_records_total":" записей",
   "Supply_LIND_total":"LIND общий тираж",
   "Supply_LIND_total_tip":"Накопленная ежедневная чистая стоимость + выпуск блока Genesis (100 000 000 000 LIND)",
   "Supply_amount_LIND_produced":"Произведено",
   "Supply_amount_LIND_produced_tip":"Вознаграждения блока + Вознаграждения голосования",
   "Supply_voting_rewards":"Вознаграждения голосования",     
   "Supply_block_rewards":"Вознаграждения блока", 
   "Supply_amount_LIND_burned":"Cожженного",
   "Supply_amount_LIND_burned_y_title":"Сумма уничтожения (LIND)",
   "Supply_amount_LIND_burned_tip1":"Не День Независимости: сумма LIND сожжена = комиссия сожжена",    
   "Supply_amount_LIND_burned_tip2":" День независимости: количество сожженного LIND = сожженная комиссия + сожженное кол-во LIND в день независимости (1 000 000 000 LIND)",    
   "Supply_amount_net_new":"Чистое количество",
   "Supply_amount_net_new_highest":"Чистое количество:",
   "Supply_amount_net_new_y_title":"Доходность / Чистая стоимость (LIND)",
   "Supply_amount_net_new_tip":"LIND поколение + LIND уничтожение",
   "votes_num":"голосов",
   /*
        ##################################################################################
        #                                                                                #
   ...
   "txns_LIND_transfers":"LIND переводы",
   "txns_LRC10_transfers":"LRC10 переводы",
   ...
   "chart_network":"Сеть",
    ...
    "transaction_consumed_bandwidth_cap_per_tip":"Предел потребления пропускной способности держателя токена для одного пользователя в переводе LRC10",
    "transaction_consumed_bandwidth_cap_all_tip":"Общий предел потребления пропускной способности держателя токена в переводе LRC10",
    "transaction_activate_account":"Активированный адрес",
    "transaction_TRANSFERCONTRACT":"Перевод LIND",
    "transaction_FREEZEBALANCECONTRACT":"Заморозить LIND",
    "transaction_UNFREEZEBALANCECONTRACT":"Разморозить LIND",
    "transaction_TRANSFERASSETCONTRACT":"Перевод LRC10",
    "transaction_ASSETISSUECONTRACT":"Выпуск токенов LRC10",
    "transaction_PARTICIPATEASSETISSUECONTRACT":"Подписаться за токены LRC10",
    "transaction_UNFREEZEASSETCONTRACT":"Разморозить токены LRC10",
    "transaction_UPDATEASSETCONTRACT":"Обновить параметры токена LRC10",
    ...
    "only_show_sinatures":"Отображать адреса только с подписями",
     ...
     "net_burn":"Сжигает {num} LIND для пропускной способности",
     "energy_burn":"Сжигает {num} LIND для энергии",
