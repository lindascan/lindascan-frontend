...
export const lang20Q1 = {
  ...
  data_account_send_Lind: "أفضل الحسابات - إجمالي LIND المرسلة",
  data_account_send_Lind_items: "أفضل الحسابات - عدد مرات LIND المرسلة",
  data_account_receive_Lind: "أفضل الحسابات - إجمالي LIND المستلمة",
  data_account_receive_Lind_items: "أفضل الحسابات - عدد مرات  LIND المستلمة",
  data_account_freeze: "أفضل الحسابات - كمية LIND المجمدة",
  ...
  data_contract_lind_number: "أفضل العقود - إجمالي رصيد LIND",
  ...
  data_resource_table_freezingLIND_energy: "إستهلاك الطاقة لتجميد LIND",
  data_resource_table_burningLIND_energy: "إستهلاك الطاقة لحرق LIND",
  ...
  // 2020-01-17 overview
  data_LIND_transfer_total: "مجموع تحويل LIND ",
  data_LIND_transfer_count: "إجمالي عدد عمليات تحويل LIND",
  data_LIND_frozen_total: "مجموع LIND المجمدة",
  data_votes_total: "مجموع الأصوات",
  data_LINDA_tokens_total: "مجموع رموز لیندا",
  data_LRC10_tokens_total: "رموز LRC10",
  data_LRC20_tokens_total: "رموز LRC20",
  data_LINDASCAN_tokens_entered: "إجمالي عدد إدخالات LINDASCAN",
  data_LINDASCAN_LRC10_entries: "إدخالات الرمز LRC10",
  data_LINDASCAN_LRC20_entries: "إدخالات الرمز LRC20",
  data_LIND_balance: "رصيد LIND",
  data_calling_accounts: "دعوات عدد حسابات ",
  data_calling_number: "عدد الدعوات",
  data_energy_consumed_total: "إجمالي الطاقة المستهلكة",
  data_energy_freezed: "إستهلاك الطاقة لتجميد LIND",
  data_energy_burned: "إستهلاك الطاقة لحرق LIND",
  data_whole_contract_use: "الطاقة من ناشر العقد",
  data_bandwidth_consumed_total: "إجمالي عرض النطاق الترددي المستهلك",
  data_bandwidth_freezed: "عرض النطاق الترددي المستهلك لتجميد LIND",
  data_bandwidth_burned: "عرض النطاق الترددي المستهلك لحرق LIND",
  ...
  index_navigation_committee: "لجنة لیندا",
  index_navigation_proposals: "اقتراح",

  // 2020-02-04
  chart_hold_lind_account:'إحصائيات الحسابات المحتفظه بـ LIND',
  chart_hold_lind_account_per:'نسبة الاحتفاظ بالعملة',
  chart_hold_lind_account_per_t:'نسبة الاحتفاظ بالعملة',
  chart_hold_lind_account_per_tip:'عدد الحسابات المحتفظه بـ LIND / إجمالي الحسابات',
  chart_hold_account_sum:'إجمالي عدد الحسابات',
  chart_hold_lind:'عدد الحسابات المحتفظه بـ LIND ',
  chart_hold_lind_more:'المزيد من البيانات',
  chart_hold_lind_number:'عدد الحسابات',
  chart_resource_user_freeing:'الطاقة من تجميد LIND',
  chart_resource_user_burning:'الطاقة من حرق LIND',
  ...
  proposal_apply_super_desc: "يمكن لكل حامل LIND التقدم ليصبح مرشحًا تمثيليًا مُمتازاً وَسيصبح من أفضل 27 مرشحًا بأعلى عدد من الأصوات ، ومن 28 إلى 127 مرشح سيصبحون شركاء للممثلين الممتازين.الممثلين الممتازين ملزمين بإنتاج كتل ومعاملات الحزمة وسيحصلون أيضًا على مكافآت التصويت والكتل المقابلة ، فلا يشارك شركاء الممثلين الممتازين في معاملات الطرود والحزم لذلك يمكنهم فقط الحصول على مكافآت التصويت ، ويحق لجميع مُرشحي الممثلين الممتازين وشركاء الممثلين الممتازين تقديم مقترحات لتعديل معايير شبكة لیندا.",
  ...
  */
  ...
  proposal_create_info: "يشير الاقتراح إلى تعديل معايير شبكة لیندا ولكل ممثل ممتاز الحق في الاقتراح والتصويت على الاقتراح ، فعندما يحصل الاقتراح على 19 صوت أو أكثر خلال فترة الصلاحية يعتبر الاقتراح مقبولًا وسيتم تعديله وفقًا لمعايير الشبكة في فترة التعديل التالية.",
  ...
  // 2020-03-03 leon
  account_total_tip: "يتم عرض أول 10000 قطعة فقط من البيانات ، ويتم فرزها بترتيب تنازلي حسب رصيد LIND افتراضيًا",
  account_rank: "الرقم",
  // account_title: "账户",
  account_balance: "إجمالي رصيد LIND",
  account_percent: "النسبة",
  account_percent_tip: "مقدار LIND الذي يحتفظ به هذا الحساب على العرض الإجمالي لدى LIND",
  account_power: "تجميد LIND (حقوق التصويت)",
  ...
  account_representative_block_desc:
    "العائد الكلي للكتل LIND {lind} ، من {block} للكتل المنتجة",
  account_representative_voters_per_tip: "الأصوات التي أدلى بها الناخب / مجموع الأصوات",
  account_representative_transfer_tip: "عدد عمليات التحويلات الرمزية لكل من LIND / LRC10 / LRC20 المتعلقة بهذا الحساب",
  ...
  address_account_table_filter_freeze: "تجميد LIND",
  address_account_table_filter_unfreeze: "إلغاء تجميد LIND",
