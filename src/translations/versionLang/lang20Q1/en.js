...
export const lang20Q1 = {
  ...
  data_account_send_Lind: "Top Accounts--Total LIND Sent",
  data_account_send_Lind_items: "Top Accounts--Txn Count Sent",
  data_account_receive_Lind: "Top Accounts--Total LIND Received",
  data_account_receive_Lind_items: "Top Accounts--Txn Count Received",
  data_account_freeze: "Top Accounts--LIND Frozen",
  ...
  data_contract_lind_number: "Top Contracts--LIND Balance",
  ...
  data_resource_table_freezingLIND_energy: "Energy from Freezing LIND",
  data_resource_table_burningLIND_energy: "Energy from Burning LIND",
  ...
  // 2020-01-17 overview
  data_LIND_transfer_total: "LIND Transfer Amount",
  data_LIND_transfer_count: "LIND Transfer Count",
  data_LIND_frozen_total: "Total LIND Frozen",
  data_votes_total: "Total Votes",
  data_LINDA_tokens_total: "Total LINDA Tokens",
  data_LRC10_tokens_total: "LRC10 Tokens",
  data_LRC20_tokens_total: "LRC20 Tokens",
  data_LINDASCAN_tokens_entered: "Tokens Entered on LINDASCAN",
  data_LINDASCAN_LRC10_entries: "LRC10 Entries",
  data_LINDASCAN_LRC20_entries: "LRC20 Entries",
  data_LIND_balance: "LIND Balance",
  ...
  data_energy_freezed: "Energy from Freezing LIND",
  data_energy_burned: "Energy from Burning LIND",
  data_whole_contract_use: "Energy from Contract Deployer",
  data_bandwidth_consumed_total: "Total Bandwidth Consumed",
  data_bandwidth_freezed: "Bandwidth from Freezing LIND",
  data_bandwidth_burned: "Bandwidth from Burning LIND",
  data_area:
  ...
  index_navigation_proposals: "PROPOSALS",
    // 2020-02-04
  chart_hold_lind_account:'Accounts holding LIND',
  chart_hold_lind_account_per:'LIND holder percentage',
  chart_hold_lind_account_per_t:'LIND holder percentage:',
  chart_hold_lind_account_per_tip:'Accounts holding LIND/Total accounts',
  chart_hold_account_sum:'Total accounts',
  chart_hold_lind:'Accounts holding LIND',
  chart_hold_lind_more:'More data',
  chart_hold_lind_number:'Number of accounts',
  chart_resource_user_freeing:'Energy from freezing LIND',
  chart_resource_user_burning:'Energy from burning LIND',
  ...
  */
  ...
  // 2020-03-03 leon
  account_total_tip: "Only the top 10000 records are displayed, sorted by decreasing LIND balance by default.",
  account_rank: "No.",
  // account_title: "账户",
  account_balance: "Total LIND balance",
  account_percent: "Percentage",
  account_percent_tip: "LIND held by this account / Total LIND supply",
  account_power: "LIND frozen (voting rights)",
  ...
  account_freeze_no_data: "No information found. ",
   ...
   account_representative_block_desc:
     "{lind} LIND earned from {block} blocks produced",
   account_representative_voters_per_tip: "Votes cast by the voter/total votes",
   account_representative_transfer_tip: "Number of LIND/LRC10/LRC20 token transfers related to this account",
  ...
  address_account_table_filter_freeze: "Freeze LIND",
  address_account_table_filter_unfreeze: "Unfreeze LIND",
