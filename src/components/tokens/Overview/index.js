...
class TokenOverview extends Component {
  ...
  onBuyInputChange = (value, price, max) => {
    ...
    this.priceLIND.innerHTML =
      intl.formatNumber(priceLIND, {
          ...
          >
            ...
            >
              ...
              <div className="text-center mt-3 text-muted">
                <b>
                  = <span ref={ref => (this.priceLIND = ref)}>0 LIND</span>
                </b>
              </div>
              <button
                className="btn btn-danger btn-block mt-3"
    ...
    if (
      ...
      try {
        if (this.props.walletType.type === "ACCOUNT_LEDGER") {
          const unSignTransaction = await lindaWebLedger.transactionBuilder.purchaseToken(
            token.ownerAddress,
            token.id + "",
